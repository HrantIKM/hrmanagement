<x-dashboard.layouts.app>
    <div class="container-fluid">
        <div class="card mb-4">
            <x-dashboard.layouts.partials.card-header :createRoute="route('dashboard.departments.create')"/>
            ...
            <div class="card-body">
                ...
                <x-dashboard.datatable._table>
                   ...
                   <th data-key="description" data-orderable="false">{{ __('label.description') }}</th>
    ...
    <x-slot name="scripts">
        <script src="{{ asset('/js/dashboard/department/index.js') }}"></script>
    </x-slot>
</x-dashboard.layouts.app>
